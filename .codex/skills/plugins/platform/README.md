...
- `.codex/skills/plugins/platform/data/` as an actual plugin root
...
- keep plugin catalogs and skills inside plugin roots such as `.codex/skills/plugins/platform/data/` and `.codex/skills/plugins/platform/devops/`
