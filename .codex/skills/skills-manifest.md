...
| github-operations | plugin | atomic | active | `.codex/skills/plugins/platform/devops/skills/github-operations/SKILL.md` | Manage GitHub workflow state across repositories, pull requests, issues, reviews, and checks while keeping adjacent execution concerns separate. |
| docker-operations | plugin | atomic | active | `.codex/skills/plugins/platform/devops/skills/docker-operations/SKILL.md` | Manage Docker workflow state across Dockerfiles, build context, images, containers, and compose services while keeping adjacent execution concerns separate. |
| postgres-operations | plugin | atomic | active | `.codex/skills/plugins/platform/data/skills/postgres-operations/SKILL.md` | Manage PostgreSQL operational state across sessions, queries, locks, indexes, and schema-risk signals while keeping adjacent execution concerns separate. |
