...
- example: `.codex/skills/plugins/platform/` is a plugin group, while `.codex/skills/plugins/platform/data/` and `.codex/skills/plugins/platform/devops/` are actual plugin roots once they contain local catalogs and `skills/`
...
INFO: validated 1 skills in plugin platform/data
INFO: validated 2 skills in plugin platform/devops
INFO: discovered plugin group backend
INFO: empty plugin scaffold backend/dotnet
INFO: empty plugin scaffold backend/python
INFO: validation passed with 15 skills checked, 0 errors, 0 warnings
```
